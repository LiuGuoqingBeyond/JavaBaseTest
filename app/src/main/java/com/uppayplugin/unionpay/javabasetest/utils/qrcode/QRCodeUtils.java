package com.uppayplugin.unionpay.javabasetest.utils.qrcode;
 ...
 * @author：- octopus on 2017/11/17 15:50
...
public class QRCodeUtils {
     ...
     * @return
     */
    public static Bitmap createColorQRCode(String str, int widthAndHeight, int color) {
        Hashtable<EncodeHintType, String> hints = new Hashtable<>();
        hints.put(EncodeHintType.CHARACTER_SET, "utf-8");
        BitMatrix matrix = null;
        try {
