...
import com.uppayplugin.unionpay.javabasetest.activity.BaseActivity;
...
public class BaseToolbar implements Toolbar.OnMenuItemClickListener {
    ...
    public BaseToolbar(View view, BaseActivity mContext) {
    ...
    public void setDefaultNavigation() {
        ...
        setNavigationOnClickListener(v -> getContext().onBackPressed());
    }
