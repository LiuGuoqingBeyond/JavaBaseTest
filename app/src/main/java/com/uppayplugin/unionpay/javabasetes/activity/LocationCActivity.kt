...
import kotlinx.android.synthetic.main.activity_location_c.*

class LocationCActivity : AppToolBarActivity(), View.OnClickListener {
    ...
    override fun getContentViewLayoutID(): Int {
        return R.layout.activity_location_c
    }
    ...
    private fun initPermission() {
        rxPermissions = RxPermissions(this@LocationCActivity)
