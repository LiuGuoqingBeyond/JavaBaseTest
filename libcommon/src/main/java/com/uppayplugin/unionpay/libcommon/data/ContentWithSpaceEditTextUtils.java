...
public class ContentWithSpaceEditTextUtils implements TextWatcher {
    ...
    public static void bind(EditText editText){
        new ContentWithSpaceEditTextUtils(editText,DEFAULT_MAX_LENGTH);
    }
    public static void bind(EditText editText, int maxLength){
        new ContentWithSpaceEditTextUtils(editText,maxLength);
    }
    public ContentWithSpaceEditTextUtils(EditText editText, int maxLength){
