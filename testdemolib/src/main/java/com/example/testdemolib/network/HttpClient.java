 ...
 * =============================================================================
 */
package com.example.testdemolib.network;
...
public class HttpClient {
	 ...
	 * @throws Exception
	 */
	public int send(String message, String encoding) throws Exception {
		try {
			HttpURLConnection httpURLConnection = createConnection(encoding);
			if(null == httpURLConnection){
				throw new Exception("创建联接失败");
			}
			this.requestServer(httpURLConnection, message,
					encoding);
	 ...
	 * @throws Exception
	 */
	public int send(String message, String encoding, String contextType) throws Exception {
		try {
			HttpURLConnection httpURLConnection = createConnection(encoding, contextType);
			if(null == httpURLConnection){
				throw new Exception("创建联接失败");
			}
			this.requestServer(httpURLConnection, message,
	 ...
	 * @throws IOException
	 */
	public String response(final HttpURLConnection connection, String encoding)
	 ...
	 */
	public HttpURLConnection createConnection(String encoding) throws ProtocolException {
	 ...
	 * @throws ProtocolException
	 */
	public HttpURLConnection createConnection(String encoding, String contextType) throws ProtocolException {
		HttpURLConnection httpURLConnection = null;
		try {
			httpURLConnection = (HttpURLConnection) url.openConnection();
		} catch (IOException e) {
		...
		httpURLConnection.setDoOutput(true); // 可写
		httpURLConnection.setUseCaches(false);// 取消缓存
		httpURLConnection.setRequestProperty("Content-type",contextType + ";charset=" + encoding);
		httpURLConnection.setRequestMethod("POST");
		if ("https".equalsIgnoreCase(url.getProtocol())) {
			HttpsURLConnection husn = (HttpsURLConnection) httpURLConnection;
			husn.setSSLSocketFactory(new BaseHttpSSLSocketFactory());
